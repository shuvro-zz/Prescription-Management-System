...
# Dumping data for table pms.medicines: ~0 rows (approximately)
/*!40000 ALTER TABLE `medicines` DISABLE KEYS */;
REPLACE INTO `medicines` (`id`, `name`) VALUES
	(8, 'napa'),
	(9, 'napa'),
	(10, 'mamunrgrdthyfdsfds'),
	(12, 'napa'),
	(13, 'napa'),
	(14, 'napa'),
	(15, 'napa'),
...
# Dumping data for table pms.tests: ~0 rows (approximately)
/*!40000 ALTER TABLE `tests` DISABLE KEYS */;
REPLACE INTO `tests` (`id`, `name`) VALUES
	(1, 'gyguh'),
	(2, 'utyuy');
...
REPLACE INTO `users` (`id`, `role_id`, `first_name`, `last_name`, `email`, `password`, `phone`, `company`, `created`, `modified`, `token`, `token_generated`) VALUES
	(6, 1, 'Larry', 'Ullman', 'admin@pms.com', '$2y$10$rhBgWQ4X71B.f.VTKJ284OvBzvZ4NWW1/fSGB8obI8QLPBL49AXzm', '523', 'Webalive', '2016-02-15 11:46:54', '2016-12-01 06:40:07', '54944a5d-6647-435e-925f-e969b704a4e7', '2016-12-01 06:39:37');
