...
INSERT INTO `attendees` (`id`, `first_name`, `surname`, `dob`, `mobile`, `telephone`, `address_line1`, `address_line2`, `email`, `post_code`, `city`, `state`, `country_id`, `attendee_type_id`, `status`, `created`, `updated`) VALUES
...
INSERT INTO `attendee_types` (`id`, `attendee_type`, `status`, `created`, `updated`) VALUES
...
INSERT INTO `conferences` (`id`, `name`, `slug`, `conference_date`, `start_time`, `end_time`, `venue_id`, `event_id`, `status`, `created`, `updated`) VALUES
...
INSERT INTO `events` (`id`, `name`, `slug`, `start_date`, `end_date`, `status`, `created`, `updated`) VALUES
...
# Dumping data for table pms.users: 1 rows
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `role_id`, `first_name`, `last_name`, `email`, `password`, `phone`, `company`, `created`, `modified`, `token`, `token_generated`) VALUES
	(6, 1, 'NACCO', 'Conference', 'admin@pms.com', '$2y$10$rhBgWQ4X71B.f.VTKJ284OvBzvZ4NWW1/fSGB8obI8QLPBL49AXzm', '523', 'Webalive', '2016-02-15 11:46:54', '2016-12-01 06:40:07', '54944a5d-6647-435e-925f-e969b704a4e7', '2016-12-01 06:39:37');
...
INSERT INTO `venues` (`id`, `name`, `slug`, `post_code`, `state`, `city`, `country_id`, `status`, `created`, `updated`) VALUES
