...
-- Dumping database structure for nacco
DROP DATABASE IF EXISTS `nacco`;
CREATE DATABASE IF NOT EXISTS `nacco` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `nacco`;

-- Dumping structure for table nacco.attendees
...
-- Dumping data for table nacco.attendees: 3 rows
...
-- Dumping structure for table nacco.attendee_types
...
-- Dumping data for table nacco.attendee_types: 1 rows
...
-- Dumping structure for table nacco.conferences
...
-- Dumping data for table nacco.conferences: 2 rows
...
-- Dumping structure for table nacco.countries
...
-- Dumping data for table nacco.countries: 243 rows
...
-- Dumping structure for table nacco.events
...
-- Dumping data for table nacco.events: 3 rows
...
REPLACE INTO `events` (`id`, `name`, `slug`, `start_date`, `end_date`, `status`, `created`, `updated`) VALUES
	...
	(14, 'sdf', 'sdf', 1502755200, 1503619200, 1, '2017-08-28 16:45:35', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `events` ENABLE KEYS */;

-- Dumping structure for table nacco.settings
...
-- Dumping data for table nacco.settings: ~8 rows (approximately)
/*!40000 ALTER TABLE `settings` DISABLE KEYS */;
REPLACE INTO `settings` (`id`, `key_name`, `value`) VALUES
	(3, 'site_name', 'NACCO'),
	(6, 'site_email', 'mizan@bitmascot.com'),
	(10, 'from_email', 'NACCO'),
...
-- Dumping structure for table nacco.states
...
-- Dumping data for table nacco.states: 59 rows
...
-- Dumping structure for table nacco.users
...
-- Dumping data for table nacco.users: 1 rows
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
REPLACE INTO `users` (`id`, `role_id`, `first_name`, `last_name`, `email`, `password`, `phone`, `company`, `created`, `modified`, `token`, `token_generated`) VALUES
	(6, 1, 'NACCO', 'Conference', 'admin@nacco.com', '$2y$10$rhBgWQ4X71B.f.VTKJ284OvBzvZ4NWW1/fSGB8obI8QLPBL49AXzm', '523', 'Webalive', '2016-02-15 11:46:54', '2016-12-01 06:40:07', '54944a5d-6647-435e-925f-e969b704a4e7', '2016-12-01 06:39:37');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

-- Dumping structure for table nacco.venues
...
-- Dumping data for table nacco.venues: 2 rows
