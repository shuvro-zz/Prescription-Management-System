<div class="workspace-dashboard page page-ui-tables">
        ...
        <div class="flex-container">
            ...
            <div class="flex-item">
                <?php echo $this->Html->link(
                    '<span class="icon">+</span> Add Diagnosi',
                    ['action' => 'add'],
                    ['class' => 'add-event-btn', 'escapeTitle' => false, 'title' => 'Add Diagnosi']
                ) ?>
            </div>
        </div>
    </div>
    ...
    <div class="event-listing">
        ...
        <div class="table-responsive table-part">
            <?php echo $this->Form->create('Diagnosis',['type' => 'post'],array('id' => 'delete-all','url'=>array('action'=>'delete-all'),'method'=>'post'));?>
