    ...
    <div class="workspace-body">
        <div class="page-heading">
            <ol class="breadcrumb breadcrumb-small">
                <li><a href="<?=$this->Url->build(array('action' => 'index' )) ?>" title="<?= __('Conference') ?>"> <?= __('Conference') ?></a></li>
                <li class="active"><a href="#">Add <?= __('Conference') ?></a></li>
            </ol>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default panel-hovered panel-stacked">
                                    <div class="panel-heading"><?= __('Add Conference') ?></div>
