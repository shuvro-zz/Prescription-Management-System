...
<div class="workspace-dashboard page page-ui-tables">
    <div class="workspace-body">
            ...
            <div class="flex-container">
                <div class="flex-item">
                    <ol class="breadcrumb breadcrumb-small">
                        ...
                        <li class="active"><a  href="#">View111111111 <?= __('Prescription') ?></a></li>
                    </ol>
                </div>
                <div class="flex-item">
                    <div class="flex-container">
        ...
        <div class="cu_con_outer" id="printable_area">
            <div class="printableArea cu_con_inner_view1">
                <div class="prescription_head prescription_view1_head">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="prescription_head_con_view1">
                                <?php $user = $this->request->session()->read('Auth.User'); ?>
                                <b><h4 style="color: #000"> <?php echo ($user['first_name']).' '.($user['last_name']) ?> </h4></b>

                                <?php if($user['educational_qualification']){?>
                                    <b><p class="view1_education"> <?php echo ($user['educational_qualification']) ?> </p></b>
                                <?php } ?>
                ...
                <div class="view1_prescription_footer">
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="view1_cember_info" style="text-align: center">
                                <h4>Cember:</h4>
                        ...
                        <div class="col-sm-5">
                            <div class="view1_show_time" style="text-align: center">
