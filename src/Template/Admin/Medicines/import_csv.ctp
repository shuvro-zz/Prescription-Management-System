    ...
    <div class="workspace-body">
        <div class="page-heading">
            <ol class="breadcrumb breadcrumb-small">
                <li><a href="<?=$this->Url->build(array('action' => 'index' )) ?>" title="<?= __('Medicines') ?>"> <?= __('Medicine') ?></a></li>
                <li class="active"><a href="#">Import <?= __('Medicines') ?></a></li>
            </ol>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default panel-hovered panel-stacked">
                                    <div class="panel-heading"><?= __('Import Medicines') ?></div>
                                    <div class="panel-body">
                                        <div class="col-sm-6">
                                            <div class="form-row">
                                                <label class="name">File<span class="required" aria-required="true"></span></label>
                                                <div class="inputs">
                                                    <?php echo $this->Form->input('csv_file', ['class' => '', 'id' => 'medicine_file', 'label' => false, 'required' => true, 'type' =>'file']); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
