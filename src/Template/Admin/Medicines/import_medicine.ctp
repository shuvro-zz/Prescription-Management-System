    ...
    <div class="workspace-body">
        <div class="page-heading">
            <ol class="breadcrumb breadcrumb-small">
                ...
                <li class="active"><a href="#">Import <?= __('Medicine') ?></a></li>
            </ol>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default panel-hovered panel-stacked">
                                    <div class="panel-heading"><?= __('Import Medicine') ?></div>
                                    <div class="panel-body">
                                        <div class="col-sm-6">
                                            <div class="form-row">
                                                <label class="name">File<span class="required" aria-required="true"></span></label>
                                                <div class="inputs">
                                                    <?php echo $this->Form->input('medicine_file', ['class' => '', 'id' => 'medicine_file', 'label' => false, 'required' => true, 'type' =>'file']); ?>
                                                </div>
                                            </div>
                                        </div>
