    ...
    <div class="workspace-body">
        <div class="page-heading">
            <ol class="breadcrumb breadcrumb-small">
                <li><a href="<?=$this->Url->build(array('action' => 'index' )) ?>" title="<?= __('Venue') ?>"> <?= __('Venue') ?></a></li>
                <li class="active"><a href="#">Edit <?= __('Venue') ?></a></li>
            </ol>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default panel-hovered panel-stacked">
                                    <div class="panel-heading"><?= __('Edit Venue') ?></div>
