...
class PrescriptionsController extends AppController
{
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow(['getOnlinePrescriptions']);
    }
...
*************************************************/
    ...
    public function getOnlinePrescriptions(){
        ...
        if ($this->request->is('get')){
            $online_prescriptions = $this->Prescriptions->find('all',
                ['contain' => ['Users', 'Medicines', 'Tests', 'Diagnosis', 'Diagnosis.DiagnosisLists']]
            )->toArray();
